...
//   const isAttending = attendingValue === 'true' || attendingValue === true;
...
//           <div className="space-y-4">
//             <fieldset>
//               <legend className="font-semibold text-gray-800 mb-3">Will you be attending?</legend>
...
//             {isAttending ? 'Confirm your attendance at the birthday party' : 'Send regrets for not being able to attend'}
//           </p>
//         </form>
//       </div>
//     </div>
